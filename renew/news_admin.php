<?php
  ...
  function fnPageNav($total,$scale,$p_num,$page,$query)
  {
        //  global $PHP_SELF;
          ...
          if ($page_list>0)
		  {
                  $navigation .= "<a href='$PHP_SELF?page=1&$query'></a>";
                  $prev_page = ($page_list-1)*$p_num+1;
                  $navigation .= "<a href='$PHP_SELF?page=$prev_page&query'></a>";
          }
          ...
          if ($page_end<$total_page)
		  {
                  ...
                  $navigation .= "<a href='$PHP_SELF?page=$total_page&$query'>→</a> ";
          }
          $navigation .= "</div>";
	...
	<div class="header">
        ...
        <div class="gnb">
        	<ul>
                ...
                <li  class="active" ><a href="news_admin.php?div_group=0">news</a> </li>
			...
			<div class="conBox">
                ...
                <?php
                  ...
                  else
                  {
                    ...
                    <tr>
    									<td>
    										<a href="./news_view_admin.php?div_group=0&idx=<?php echo $row['idx']?>"><p class="title"><?php echo $tmp_title;?></p>
    										<p class="inform">
