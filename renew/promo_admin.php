			...
			<div class="conBox">
				<div class="board">
					...
					<ul class="box_cate">
						...
						<li class="<?=$div_group=='0'?'active':''?>"><a href="news_admin.php?div_group=0"><img src="images/common/ico_notice_off.png"><span>notice</span></a></li>
						<li class="<?=$div_group=='1'?'active':''?>"><a href="promo_admin.php?div_group=1"><img src="images/common/ico_event_on.png"><span>Promotion</span></a></li>
					</ul>
					<!-- /카테고리 -->
