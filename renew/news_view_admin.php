...
include $_SERVER["DOCUMENT_ROOT"]."/renew/login_check.php";
  ...
  $sql = "select title, content, stamp, view_yn from notice_board where idx=". $idx;
				...
				<div class="board">
					...
					<div class="board_con">
						...
						<div class="buttonWrap">
							<a href="news_write.php?<?=$div_group?>&idx=<?=$idx?>&view_yn=<?=$view_yn?>" class="button dark">수정</a>
							<a href="news_delete_admin.php?<?=$div_group?>&idx=<?=$idx?>" class="button dark">삭제</a>
